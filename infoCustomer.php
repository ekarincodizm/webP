...
<html lang="en">
    <head>
        ...
        <title>ข้อมูลลูกค้า - ระบบบริหารอู่ซ่อมรถ - บริษัท เนตรวชิรกุล จำกัด</title>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="infoCustomer.php"><span class="glyphicon glyphicon-user"></span> ข้อมูลลูกค้า </a></li>
