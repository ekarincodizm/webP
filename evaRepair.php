...
<html lang="en">
    <head>
        ...
        <title>ประเมินการซ่อม - ระบบบริหารอู่ซ่อมรถ - บริษัท เนตรวชิรกุล จำกัด</title>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="evaRepair.php"><span class="glyphicon glyphicon-list-alt"></span> ประเมินการซ่อม </a></li>
                        ...
                        <li><a href="sparePart.php"><span class="glyphicon glyphicon-cog"></span> อะไหล่ </a></li>
                        <li class="dropdown">
