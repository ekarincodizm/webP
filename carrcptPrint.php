...
<html lang="en">
    <head>
        ...
        <title>ใบรับรถ - ระบบบริหารอู่ซ่อมรถ - บริษัท เนตรวชิรกุล จำกัด</title>
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="carrcptPrint.php"><span class="glyphicon glyphicon-file"></span> ใบรับรถ </a></li>
